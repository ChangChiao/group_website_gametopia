  ...
  <div class="back">
      ...
      <div class="Qbox">
        ...
        <div class="Qtype">
          ...
          <div class="Qtypes" id="gameTypeAVG">冒險</div>
          <div class="Qtypes" id="gameTypeACT">動作</div>
          <div class="Qtypes" id="gameTypeMMO">多人</div>
          <div class="Qtypes" id="gameTypeRAC">競速</div>
          <div class="Qtypes" id="gameTypeSLG">策略</div>
          <div class="Qtypes" id="gameTypeSPT">運動</div>
          <div class="Qtypes" id="gameTypeSTG">射擊</div>
          <div class="Qtypes" id="gameTypeRPG">角色扮演</div>
          
        </div>
        <!-- 平台問題 -->
        <div class="QgameMom">
          <div class="QgameMomQ">請選擇遊戲平台</div>
          <div class="QgameMoms" id="gamePS">PS</div>
          <div class="QgameMoms" id="gameXBOX">XBOX</div>
          <div class="QgameMoms" id="gameHH">掌機</div>
          <div class="QgameMoms" id="gamePC">PC</div>
        </div>
      ...
      <div class="productLightbox">
        <div class="productTitle">
          ...
          <h2 class="productName" id="SH_productName">逗陣特攻</h2>
        </div>
      </div>
          ...
          <div class="productPaW">
            ...
            <div class="productTable">
              <table class="productWord">
                <tr>
                  <td colspan="2">
                    <h2 id="SH_productName">鬥陣特攻 啟元版</h2>
                  </td>
                </tr>
                <tr>
                  <td colspan="2">
